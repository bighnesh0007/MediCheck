...
const models: Model[] = [
  { 
    ...
    endpoint: 'https://detect.roboflow.com/eye-conjunctiva-detector/2',
    description: 'Detects Eye_Conjunctiva in medical images'
  }
...
export function EyeConjunctivaAdvancedDetectionForm() {
