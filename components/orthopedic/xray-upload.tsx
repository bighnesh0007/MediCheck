...
export function XrayDetectionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const predictions: DetectionResult[] = response.data.predictions.filter((pred: DetectionResult) => pred.confidence >= confidenceThreshold)
  ...
  const processImage = async (file: File, predictions: DetectionResult[]): Promise<string> => {
